...
function drawSnake() {
    ...
    gradient.addColorStop(0, 'rgba(131,58,180,1)'); // Blue color for the head
    gradient.addColorStop(0.5, 'rgba(253,29,29,1)'); // Red color for the middle
    gradient.addColorStop(1, 'rgba(252,176,69,1)'); // Yellow color for the tail
    
    snake.forEach(({ x, y }) => {
        // Apply glow effect to each cell of the snake
        ctx.shadowColor = 'rgba(255, 255, 255, 0.5)'; // Set the shadow color to white
        ctx.shadowBlur = 20; // Adjust shadow blur to create a glowing effect
        
        // Draw the snake cell with gradient color
